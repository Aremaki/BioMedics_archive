...
cd '/export/home/cse200093/Pierre_Medic/NEURAL_BASED_NER/eds-medic'
echo -----------------
python -m spacy project dvc

echo project.yml built succesfully

dvc repro -f 2>&1 | tee training/model-NLP-diabeto/train.log
